        ...
        content={
          <div style={{'padding':'10px'}}>
            <ul>
              ...
              <li><a href={extraConfigs.doReferral} target='_blank' rel='noopener noreferrer'>Digital Ocean Droplets</a></li>
              <li><a href={extraConfigs.siteRepo} target='_blank' rel='noopener noreferrer'>This React Dashboard</a> with special thanks to Tim, Brandon and Jon</li>
