var siteData = {
  ...
  siteLogo:"fab fa-2x fa-foursquare",
  siteLogoColor:"#CD4B4B",
  welcomeBanner:true, // If true, the welcome banner will be displayed.
  welcomeBannerText:"Welcome to <b>Fairbanks.io</b> - this site is under active development. Please stay tuned!",
  welcomeBannerLogo:"fas fa-fighter-jet",
  welcomeBannerType:"warning", // Must be of type: info | success | warning | error
  ...
  pages: [
    ...
    elements: [
        ...
        { component: 'UnorderedListCard',
          props: {
            ...
            listDescription: "This page brought to you by:",
            listItems: [
              "Li1",
              "L12",
              "<a href='www.google.com'>verify html inline working </a>"
            ],
            col_md: 4,
            doReferral: '/#',
            ...
            workExperience: [
              {
                ...
                "JobDescription":"Technical Migration and Business Acquistion SME for enterprise infrastructure. Deploy/Manage identity management and cloud hosted solutions. Scale infrastructure and merge manufacturing facilities from acqusition.",
                "StartDate":"Nov 2017",
                "EndDate":"Current",
    ...
    { redirect: true, path: "/", to: "/home", name: "Home" } //not needed if you define page for '/'
  ]
};
